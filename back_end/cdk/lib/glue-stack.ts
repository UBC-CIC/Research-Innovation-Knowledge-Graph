...
export class GlueStack extends Stack {
  ...
  constructor(
    ...
    const grantDataS3Bucket = new s3.Bucket(this, "knowledgeGraph-grant-data-s3-bucket", {
      removalPolicy: cdk.RemovalPolicy.DESTROY,
      autoDeleteObjects: true,
      versioned: false,
      publicReadAccess: false,
    ...
    const glueTrigger = new lambda.Function(this, "knowledgeGraph-s3-glue-trigger", {
      runtime: lambda.Runtime.PYTHON_3_9,
      functionName: "knowledgeGraph-s3-glue-trigger",
